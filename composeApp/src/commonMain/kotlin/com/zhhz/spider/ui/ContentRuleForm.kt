...
@Composable
fun ContentRuleForm(contentRule: ContentPage?,onOpenJsEditor: (JsEditContext) -> Unit, onUpdate: (ContentPage) -> Unit) {
    if (contentRule == null) {
        ...
        Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            SelectorEditor("搜索地址 (可选)", contentRule.urlSelector,onOpenJsEditor = onOpenJsEditor) {
            ...
            SelectorEditor("正则净化", contentRule.regexReplaceSelector,onOpenJsEditor = onOpenJsEditor) { onUpdate(contentRule.copy(regexReplaceSelector = it)) }
